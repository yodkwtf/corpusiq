...
export const branding = {
  appName: "WealthPath", // placeholder - easy to rename later
  ...
  footer: {
    ...
    copyrightText: "© 2025 WealthPath. All rights reserved.",
...
export function applyBranding() {
  ...
  if (meta) meta.setAttribute("content", `${branding.appName}: ${branding.tagline}`);
}
